...
A complete Java implementation for the "ITHAKI Virtual Modem" project (AUTH ECE – Computer Networks).
Includes RTT measurements, ARQ retransmission analysis, GPS parsing, JPEG retrieval, and structured session outputs.

This repository contains a modular Java implementation for analyzing modem-based communication using the Ithaki Virtual Modem.
...
Two experiment sessions (“session1” and “session2”) are included.
...
GPSHandler.java	Parses GPS NMEA data and constructs map image requests.
